...
// Safe under the shallow-import rule below: planMode pulls in zod, a type, and
// artifacts/artifactLimits — which imports nothing at all, and says so, for this reason.
